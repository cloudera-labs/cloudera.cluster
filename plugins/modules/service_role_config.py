...
EXAMPLES = r"""
---
- name: Update (append) service-wide role parameters
...
- name: Reset a service-wide role parameter
...
- name: Update (purge) service-wide role parameters
  cloudera.cluster.cluster_service_role_config:
    host: example.cloudera.com
    username: "jane_smith"
    password: "S&peR4Ec*re"
...
- name: Reset all service-wide role parameters
  cloudera.cluster.cluster_service_role_config:
    host: example.cloudera.com
    username: "jane_smith"
    password: "S&peR4Ec*re"
