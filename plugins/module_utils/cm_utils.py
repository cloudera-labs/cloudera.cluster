...
"""
A common Ansible Module for shared functions for Cloudera Manager
"""
...
class ClouderaManagerModule(object):
    ...
    def _discover_endpoint(self, config):
        ...
        pre_rendered = Url(scheme="https" if self.force_tls else "http", host=self.host, port=self.port)
    ...
    @staticmethod
    def ansible_module(argument_spec={}, mutually_exclusive=[], required_one_of=[], required_together=[], **kwargs):
